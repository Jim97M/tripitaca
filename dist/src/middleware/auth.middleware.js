...
let AuthMiddleware = class AuthMiddleware {
    ...
    async use(req, res, next) {
        ...
        if (isBlacklisted) {
            return res.status(common_1.HttpStatus.UNAUTHORIZED).json({ message: 'Token is blacklisted' });
        }
        try {
...
AuthMiddleware = __decorate([
    ...
    __metadata("design:paramtypes", [user_service_1.UserService, jwt_service_1.JwtService])
], AuthMiddleware);
